...
![Instalación del proyecto](docs/levantandoelproyecto.png)

### Instalación de React Compiler

![React Compiler](docs/evidencia-01-instalacion-react-compiler.png)

### Configuración de Tailwind CSS

![Tailwind CSS](docs/03-tailwind-funcionando.png)

![Tailwind CSS 2](docs/03-tailwind-funcionando2.png)

### Instalación de Shadcn UI

![Shadcn Instalación](docs/04-shadcn-instalacion.png)

### Configuración de Shadcn UI

![Shadcn Configurado](docs/04-shadcn-configurado.png)

### Configuración de rutas

#### Ruta Home

![Home Route](docs/05-01-home-route.png)

#### Ruta Entities

![Entities Route](docs/05-02-entities-route.png)

### Consumo de la API FakeStore

![Consumo API](docs/06-consumo-api-funcionando.png)

### Catálogo de productos

![Catálogo](docs/07-home-catalogo-productos.png)

### Vista de entidades

![Entities](docs/08-entities-page.png)

### Navegación entre páginas

![Navbar](docs/09-navbar-funcionando.png)
